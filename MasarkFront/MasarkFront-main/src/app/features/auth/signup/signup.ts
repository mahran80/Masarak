...
const AR = {
  ...
  heroSubheadlineParent: 'تابع التقدم الدراسي، الحضور، الواجبات، والتقارير من أي مكان في العالم.',
...
const EN = {
  ...
  heroSubheadlineParent: 'Track child\'s academic progress, attendance, assignments, and reports from anywhere in the world.',
