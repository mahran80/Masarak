...
namespace Masarak.Infrastructure.Persistence.Migrations
{
    ...
    [Migration("20260705213131_AddLessonsFeature")]
    partial class AddLessonsFeature
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Masarak.Domain.Entities.Class", b =>
                {
                    ...
                    b.HasIndex("GradeId", "Name", "AcademicYear")
                        .IsUnique()
            ...
            modelBuilder.Entity("Masarak.Domain.Entities.Exam", b =>
                {
                    ...
                    b.HasIndex("AssignmentId", "StartTime");
            ...
            modelBuilder.Entity("Masarak.Domain.Entities.Grade", b =>
                {
                    ...
                    b.HasIndex("Order")
                        .IsUnique()
                        .HasDatabaseName("UX_grades_Order");

                    b.ToTable("grades", (string)null);
                });

            modelBuilder.Entity("Masarak.Domain.Entities.Lesson", b =>
                {
                    b.Property<int>("LessonId")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
                    ...
                    b.HasIndex("TeachingAssignmentId", "OrderNum")
            ...
            modelBuilder.Entity("Masarak.Domain.Entities.QuestionOption", b =>
                {
            ...
            modelBuilder.Entity("Masarak.Domain.Entities.Session", b =>
                {
                    ...
                    b.HasIndex("SeriesId")
                        .HasDatabaseName("IX_sessions_SeriesId");

                    b.HasIndex("AssignmentId", "ScheduledAt")
                        .HasDatabaseName("IX_sessions_Assignment_ScheduledAt");
            ...
            modelBuilder.Entity("Masarak.Domain.Entities.StudentAnswer", b =>
                {
                    ...
                    b.HasIndex("GradingStatus")
                        .HasFilter("[GradingStatus] = 'PendingReview'");
            ...
            modelBuilder.Entity("Masarak.Domain.Entities.StudentClass", b =>
                {
                    ...
                    b.HasIndex("StudentId", "AcademicYear")
                        .IsUnique()
                        .HasDatabaseName("UX_student_classes_Student_Year");

                    b.ToTable("student_classes", (string)null);
                });

            modelBuilder.Entity("Masarak.Domain.Entities.StudentClassSubject", b =>
                {
                    b.Property<int>("StudentClassId")
                        .HasColumnType("int");
                    ...
                    b.HasKey("StudentClassId", "SubjectId");

                    b.HasIndex("SubjectId");

                    b.ToTable("student_class_subjects", (string)null);
                });
            ...
            modelBuilder.Entity("Masarak.Domain.Entities.StudentExam", b =>
                {
                    ...
                    b.Property<bool>("HasPendingManualGrading")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("bit")
                        .HasDefaultValue(false);
            ...
            modelBuilder.Entity("Masarak.Domain.Entities.StudentPerformance", b =>
                {
                    ...
                    b.Property<int>("TotalAssignmentsPending")
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("Masarak.Domain.Entities.SubscriptionSubject", b =>
                {
                    b.Property<int>("SubscriptionId")
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("Masarak.Domain.Entities.TeachingAssignment", b =>
                {
                    ...
                    b.HasIndex("SubjectId", "ClassId", "AcademicYear")
                        .IsUnique()
            ...
            modelBuilder.Entity("Masarak.Domain.Entities.Assignment", b =>
                {
                    ...
                    b.HasOne("Masarak.Domain.Entities.Lesson", "Lesson")
                        .WithMany("Assignments")
            ...
            modelBuilder.Entity("Masarak.Domain.Entities.StudentClassSubject", b =>
                {
                    b.HasOne("Masarak.Domain.Entities.StudentClass", "StudentClass")
